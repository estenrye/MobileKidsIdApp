...
class ChildProfileChildBasicsController implements IControllerNavigation {
    private _state;
    private _scope;
...
angular.module('mcmapp').controller('childProfileChildBasicsController', ChildProfileChildBasicsController);