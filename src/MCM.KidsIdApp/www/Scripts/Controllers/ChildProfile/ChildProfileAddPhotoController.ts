...
class ChildProfileAddPhotoController implements IControllerNavigation {
    private _state;
    private _scope;
...
angular.module('mcmapp').controller('childProfileAddPhotoController', ChildProfileAddPhotoController);